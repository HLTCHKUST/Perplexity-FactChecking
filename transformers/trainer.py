...
class Trainer:
    ...
    def predict_perpelxity(self, test_dataset: Dataset):
        test_dataloader = self.get_test_dataloader(test_dataset)
        return self._prediction_perplexity_loop(test_dataloader, description="Perplexity Prediction")

    def _prediction_perplexity_loop(
        ...
        for inputs in tqdm(dataloader, desc=description):
            ...
            if len(eval_losses) > 0:
                ...
                perplexity_results.append({"perplexity": perplexity})
